...
class TestTonUtilsAsync(aiounittest.AsyncTestCase):
    async def test_convert_address(self):
        ...
        converted = await client.utils.convert_address(
        ...
        with self.assertRaises(TonException):
            await client.utils.convert_address(
