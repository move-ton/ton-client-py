...
class TonCrypto(TonModule):
    ...
    def hdkey_xprv_from_mnemonic(
        ...
        Awaitable[ResultOfHDKeyXPrvFromMnemonic]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfHDKeyXPrvFromMnemonic, response=response)

    def hdkey_secret_from_xprv(
            self, params: ParamsOfHDKeySecretFromXPrv
    ) -> Union[
        ResultOfHDKeySecretFromXPrv,
        Awaitable[ResultOfHDKeySecretFromXPrv]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfHDKeySecretFromXPrv, response=response)

    def hdkey_public_from_xprv(
            self, params: ParamsOfHDKeyPublicFromXPrv
    ) -> Union[
        ResultOfHDKeyPublicFromXPrv,
        Awaitable[ResultOfHDKeyPublicFromXPrv]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfHDKeyPublicFromXPrv, response=response)

    def hdkey_derive_from_xprv(
            self, params: ParamsOfHDKeyDeriveFromXPrv
    ) -> Union[
        ResultOfHDKeyDeriveFromXPrv,
        Awaitable[ResultOfHDKeyDeriveFromXPrv]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfHDKeyDeriveFromXPrv, response=response)

    def hdkey_derive_from_xprv_path(
            self, params: ParamsOfHDKeyDeriveFromXPrvPath
    ) -> Union[
        ResultOfHDKeyDeriveFromXPrvPath,
        Awaitable[ResultOfHDKeyDeriveFromXPrvPath]
    ]:
        """
    ...
    def convert_public_key_to_ton_safe_format(
        ...
        response = self.request(
            ...
            **params.dict)
        return self.response(
            classname=ResultOfConvertPublicKeyToTonSafeFormat,
            response=response)
    ...
    def verify_signature(
        ...
        """
        response = self.request(
            method='crypto.verify_signature', **params.dict)
        return self.response(
            classname=ResultOfVerifySignature, response=response)
    ...
    def generate_random_bytes(
        ...
        Awaitable[ResultOfGenerateRandomBytes]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfGenerateRandomBytes, response=response)
    ...
    def mnemonic_words(
        ...
        return self.response(
            classname=ResultOfMnemonicWords, response=response)

    def mnemonic_from_random(
            self, params: ParamsOfMnemonicFromRandom
    ) -> Union[
        ResultOfMnemonicFromRandom,
        Awaitable[ResultOfMnemonicFromRandom]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfMnemonicFromRandom, response=response)

    def mnemonic_from_entropy(
            self, params: ParamsOfMnemonicFromEntropy
    ) -> Union[
        ResultOfMnemonicFromEntropy,
        Awaitable[ResultOfMnemonicFromEntropy]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfMnemonicFromEntropy, response=response)
    ...
    def mnemonic_verify(
        ...
        return self.response(
            classname=ResultOfMnemonicVerify, response=response)
    ...
    def nacl_sign_detached(
        ...
        """
        response = self.request(
            method='crypto.nacl_sign_detached', **params.dict)
        return self.response(
            classname=ResultOfNaclSignDetached, response=response)

    def nacl_sign_detached_verify(
            self, params: ParamsOfNaclSignDetachedVerify
    ) -> Union[
        ResultOfNaclSignDetachedVerify,
        Awaitable[ResultOfNaclSignDetachedVerify]
    ]:
        """
    ...
    def signing_box_get_public_key(
        ...
        Awaitable[ResultOfSigningBoxGetPublicKey]
    ]:
        """
    ...
    def signing_box_sign(
        ...
        """
        response = self.request(
            method='crypto.signing_box_sign', **params.dict)
        return self.response(
            classname=ResultOfSigningBoxSign, response=response)
    ...
    def register_encryption_box(
        ...
        return self.response(
            classname=RegisteredEncryptionBox, response=response)
    ...
    def encryption_box_get_info(
        ...
        Awaitable[ResultOfEncryptionBoxGetInfo]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfEncryptionBoxGetInfo, response=response)

    def encryption_box_encrypt(
            self, params: ParamsOfEncryptionBoxEncrypt
    ) -> Union[
        ResultOfEncryptionBoxEncrypt,
        Awaitable[ResultOfEncryptionBoxEncrypt]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfEncryptionBoxEncrypt, response=response)

    def encryption_box_decrypt(
            self, params: ParamsOfEncryptionBoxDecrypt
    ) -> Union[
        ResultOfEncryptionBoxDecrypt,
        Awaitable[ResultOfEncryptionBoxDecrypt]
    ]:
        """
        ...
        return self.response(
            classname=ResultOfEncryptionBoxDecrypt, response=response)
