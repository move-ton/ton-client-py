...
class TonCrypto(TonModule):
    ...
    def sha256(self, data: Union[str, bytes]) -> str:
        ...
        if type(data) is bytes:
            data = data.decode()
        return self.request(function_name='crypto.sha256', data=data)
    ...
    def sha512(self, data: Union[str, bytes]) -> str:
        ...
        if type(data) is bytes:
            data = data.decode()
        return self.request(function_name='crypto.sha512', data=data)
    ...
    def hdkey_xprv_from_mnemonic(self, phrase: str) -> str:
        ...
        """
        return self.request(
            function_name='crypto.hdkey_xprv_from_mnemonic', phrase=phrase)
    ...
    def hdkey_secret_from_xprv(self, xprv: str) -> str:
        ...
        """
        return self.request(
            function_name='crypto.hdkey_secret_from_xprv', xprv=xprv)
    ...
    def hdkey_public_from_xprv(self, xprv: str) -> str:
        ...
        """
        return self.request(
            function_name='crypto.hdkey_public_from_xprv', xprv=xprv)
    ...
    def hdkey_derive_from_xprv(
        ...
        """
        return self.request(
            function_name='crypto.hdkey_derive_from_xprv', xprv=xprv,
    ...
    def hdkey_derive_from_xprv_path(
        ...
        """
        return self.request(
            function_name='crypto.hdkey_derive_from_xprv_path', xprv=xprv,
            path=path)
    ...
    def convert_public_key_to_ton_safe_format(self, public_key: str) -> str:
        ...
        """
        return self.request(
            function_name='crypto.convert_public_key_to_ton_safe_format',
    ...
    def generate_random_sign_keys(self) -> KeyPair:
        ...
        :return:
        """
        return self.request(function_name='crypto.generate_random_sign_keys')
    ...
    def sign(
        ...
        return self.request(
            function_name='crypto.sign', unsigned=unsigned, keys=keys.dict)
    ...
    def verify_signature(self, signed: Union[str, bytes], public: str) -> str:
        ...
        return self.request(
            function_name='crypto.verify_signature', signed=signed,
            public=public)
    ...
    def modular_power(self, base: str, exponent: str, modulus: str) -> str:
        ...
        """
        return self.request(
            function_name='crypto.modular_power', base=base, exponent=exponent,
            modulus=modulus)
    ...
    def factorize(self, composite: str) -> List[str]:
        ...
        """
        return self.request(
            function_name='crypto.factorize', composite=composite)
    ...
    def ton_crc16(self, data: Union[str, bytes]) -> int:
        ...
        if type(data) is bytes:
            data = data.decode()
        return self.request(function_name='crypto.ton_crc16', data=data)
    ...
    def generate_random_bytes(self, length: int) -> str:
        ...
        """
        return self.request(
            function_name='crypto.generate_random_bytes', length=length)
    ...
    def mnemonic_words(
        ...
        """
        return self.request(
            function_name='crypto.mnemonic_words', dictionary=dictionary)
    ...
    def mnemonic_from_random(
        ...
        """
        return self.request(
            function_name='crypto.mnemonic_from_random', dictionary=dictionary,
    ...
    def mnemonic_from_entropy(
        ...
        """
        return self.request(
            function_name='crypto.mnemonic_from_entropy', entropy=entropy,
    ...
    def mnemonic_verify(
        ...
        """
        return self.request(
            function_name='crypto.mnemonic_verify', phrase=phrase,
            dictionary=dictionary, word_count=word_count)
    ...
    def mnemonic_derive_sign_keys(
        ...
        """
        return self.request(
            function_name='crypto.mnemonic_derive_sign_keys', phrase=phrase,
    ...
    def nacl_sign_keypair_from_secret_key(self, secret: str) -> KeyPair:
        ...
        """
        return self.request(
            function_name='crypto.nacl_sign_keypair_from_secret_key',
            secret=secret)
    ...
    def nacl_sign(self, unsigned: Union[str, bytes], secret: str) -> str:
        ...
        if type(unsigned) is bytes:
            unsigned = unsigned.decode()
        return self.request(
            function_name='crypto.nacl_sign', unsigned=unsigned, secret=secret)
    ...
    def nacl_sign_detached(
        ...
        if type(unsigned) is bytes:
            unsigned = unsigned.decode()
        return self.request(
            function_name='crypto.nacl_sign_detached', unsigned=unsigned,
            secret=secret)
    ...
    def nacl_sign_open(self, signed: Union[str, bytes], public: str) -> str:
        ...
        if type(signed) is bytes:
            signed = signed.decode()
        return self.request(
            function_name='crypto.nacl_sign_open', signed=signed,
            public=public)

    @Response.nacl_box_keypair
    def nacl_box_keypair(self) -> KeyPair:
        return self.request(function_name='crypto.nacl_box_keypair')
    ...
    def nacl_box_keypair_from_secret_key(self, secret: str) -> KeyPair:
        ...
        """
        return self.request(
            function_name='crypto.nacl_box_keypair_from_secret_key',
            secret=secret)
    ...
    def nacl_box(
        ...
        return self.request(
            function_name='crypto.nacl_box', decrypted=decrypted, nonce=nonce,
    ...
    def nacl_box_open(
        ...
        return self.request(
            function_name='crypto.nacl_box_open', encrypted=encrypted,
    ...
    def nacl_secret_box(
        ...
        if type(decrypted) is bytes:
            decrypted = decrypted.decode()
        return self.request(
            function_name='crypto.nacl_secret_box', decrypted=decrypted,
            nonce=nonce, key=key)
    ...
    def nacl_secret_box_open(
        ...
        if type(encrypted) is bytes:
            encrypted = encrypted.decode()
        return self.request(
            function_name='crypto.nacl_secret_box_open', encrypted=encrypted,
            nonce=nonce, key=key)
    ...
    def scrypt(
        ...
        if type(salt) is bytes:
            salt = salt.decode()
        return self.request(
            function_name='crypto.scrypt', password=password, salt=salt,
